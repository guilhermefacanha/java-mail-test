...
public class EmailService {
    ...
    public void enviarEmailGmail(String remetente, String destinatario, String assunto, String mensagem) {
    ...
    public void enviarEmailSimples(String remetente, String destinatario, String assunto, String mensagem) throws Exception {
    ...
    public void enviarEmailSimples(String remetente, String[] destinatario, String assunto, String mensagem) throws Exception {
        ...
        try {
            ...
            email.setSSL(this.ssl);
            email.setTLS(this.tsl);
    ...
    public void enviarEmailAnexo(String remetente, String[] destinatario, String assunto, String mensagem, File[] arquivos)
            throws Exception {
        try {
            remetente = StringUtils.defaultString(remetente, usuario);
    ...
    public boolean enviarEmailIntranet(String remetentes, String destinatario, String assunto, String mensagem) throws EmailException {
        try {
            SimpleEmail email = new SimpleEmail();
            email.setHostName(host);
